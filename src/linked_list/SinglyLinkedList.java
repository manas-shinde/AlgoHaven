...
public class SinglyLinkedList {
    ...
    /**
     * Insert a new node with the given data at the specified index (0-based).
     *
     * @param data The data to be inserted.
     * @param idx  The index at which the data should be inserted.
     * @return 1 if the node is inserted successfully, -1 for failure.
     */
    public int insertAt(int data, int idx) throws NullPointerException {
        if (this.head == null) {
